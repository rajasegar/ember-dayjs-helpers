...
return e.replace(H,q)},e.getTemplate=function(e){if(Object.prototype.hasOwnProperty.call(In,e))return In[e]},e.getTemplates=function(){return In},e.hasTemplate=function(e){return Object.prototype.hasOwnProperty.call(In,e)},e.helper=At,e.htmlSafe=$,e.isHTMLSafe=Y,Object.defineProperty(e,"isSerializationFirstNode",{enumerable:!0,get:function(){return b.isSerializationFirstNode}}),e.modifierCapabilities=void 0,e.renderSettled=function(){null===xn&&(xn=x.default.defer(),(0,m._getCurrentRunLoop)()||m._backburner.schedule("actions",null,jn))
...
return Q(e,t,n,g,!1)},e.addListener=g,e.addNamespace=function(e){qe.unprocessedNamespaces=!0,Ye.push(e)},e.addObserver=R,e.alias=function(e){return se(new Ne(e),Me)},e.aliasMethod=void 0,e.applyMixin=ut,e.arrayContentDidChange=$,e.arrayContentWillChange=q,e.autoComputed=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n]
return se(new Ce(t),je)},e.beginPropertyChanges=V,e.changeProperties=H,e.computed=xe,Object.defineProperty(e,"createCache",{enumerable:!0,get:function(){return u.createCache}}),e.defineProperty=me,e.deprecateProperty=function(e,t,n,r){Object.defineProperty(e,t,{configurable:!0,enumerable:!1,set:function(e){Te(this,n,e)},get:function(){return we(this,n)}})},e.descriptorForDecorator=ce,e.descriptorForProperty=le,e.eachProxyArrayDidChange=function(e,t,n,r){var i=Le.get(e)
...
return ut(e,n),e},e.nativeDescDecorator=ne,e.notifyPropertyChange=U,e.objectAt=W,e.observer=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n]
var i,a,s,u=t.pop()
...
delete We[t],Ye.splice(Ye.indexOf(e),1),t in o.context.lookup&&e===o.context.lookup[t]&&(o.context.lookup[t]=void 0)}
e.removeObserver=T,e.replace=function(e,t,n,r){void 0===r&&(r=Y)
Array.isArray(e)?G(e,t,n,r):e.replace(t,n,r)},e.replaceInNativeArray=G,e.sendEvent=y,e.set=Te,e.setClassicDecorator=de,e.setNamespaceSearchDisabled=function(e){He=Boolean(e)},e.setProperties=function(e,t){if(null===t||"object"!=typeof t)return t
...
return M(e,0)},e.intern=r,e.isEmberArray=function(e){return W.has(e)},e.isInternalSymbol=function(e){return-1!==f.indexOf(e)},e.isObject=i,e.isProxy=function(e){if(i(e))return z.has(e)
return!1},e.lookupDescriptor=I,e.makeArray=function(e){if(null==e)return[]
return L(e)?e:[e]},e.observerListenerMetaFor=function(e){return E.get(e)},e.setEmberArray=function(e){W.add(e)},e.setListeners=function(e,t){R(e).listeners=t},e.setName=function(e,t){i(e)&&F.set(e,t)},e.setObservers=function(e,t){R(e).observers=t},e.setProxy=function(e){i(e)&&z.add(e)},e.teardownMandatorySetter=e.symbol=e.setupMandatorySetter=e.setWithMandatorySetter=void 0,e.toString=function e(t){if("string"==typeof t)return t
...
0
return r},e.createTag=function(){return new b(0)},e.createUpdatableTag=w,e.dirtyTag=e.deprecateMutationsInTrackingTransaction=void 0,e.dirtyTagFor=M,e.endTrackFrame=U,e.endTrackingTransaction=void 0,e.endUntrackFrame=z,e.getValue=function(e){G(e,"getValue")
var t=e[q],n=e[Y],r=e[W]
if(void 0!==n&&m(n,r))H(n)
else{B()
try{e[$]=t()}finally{n=U(),e[Y]=n,e[W]=h(n),H(n)}}return e[$]},e.isConst=function(e){G(e,"isConst")
var t=e[Y]
